...
const NFTDetail = () => {
  ...
  const handleBuyClick = async () => {
    if (allowance === 0) {
      await approve("0x66fc772e1E92325D59B4d4F19A46f4514c9F1dfd", "10000000000000000000000");
    } else {
      await buy(tokenId);
    }
  };
  ...
  useEffect(() => {
    const getInfo = async () => {
      ...
      const allowance = await getAllowance(address, "0x66fc772e1E92325D59B4d4F19A46f4514c9F1dfd");
